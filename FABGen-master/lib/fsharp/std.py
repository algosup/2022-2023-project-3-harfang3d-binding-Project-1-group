...
# 	gen.bind_type(FSharpBasicTypeConverter("char", "char", "sbyte"))
...
# 	gen.bind_type(FSharpBasicTypeConverter("char16_t", "uint16", "uint16"))

# 	gen.bind_type(FSharpBasicTypeConverter("int", "int32", "int32"))
# 	gen.bind_type(FSharpBasicTypeConverter("int32_t", "int32", "int32"))
# 	gen.bind_type(FSharpBasicTypeConverter("char32_t", "int32", "int32"))
...
# 	# gen.bind_type(FSharpBasicTypeConverter("char32_t", "uint32", "uint32"))
...
# 	gen.bind_type(FSharpBasicTypeConverter("float", "float32", "float32"))
# 	gen.bind_type(FSharpBasicTypeConverter("float32_t", "float32", "float32"))

# 	gen.bind_type(FSharpBasicTypeConverter("double", "float64", "float64"))
# 	gen.bind_type(FSharpBasicTypeConverter("float64_t", "float64", "float64"))

# 	gen.bind_type(FSharpBasicTypeConverter("size_t", "size_t", "size_t"))
